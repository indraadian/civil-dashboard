                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Belum punya akun
                                    <a href="/register" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Register disini</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            © 2026 <a target="_blank" href="https://indraadian.github.io/fortopolio/" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Indra Adian</a>
                        </p>
                    </div>
                </div>
            </div>
