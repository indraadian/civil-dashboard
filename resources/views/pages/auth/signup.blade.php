                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Masukan email dan kata sandi untuk registrasi
                        </p>
                    </div>
                    <div>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Sudah punya akun?
                                <a href="/login" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Masuk</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            © 2026 <a target="_blank" href="https://indraadian.github.io/fortopolio/"
                                class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Indra
                                Adian</a>
                        </p>
                    </div>
                </div>
